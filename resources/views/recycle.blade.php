    	...
    	<div class="row content">
    		<div class="sidenav col-2">
	    		...
	    		<ul class="nav nav-pills flex-column">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="">Recycle Bin</a></li>
            ...
            <div class="main-content col-10">
                ...
                @if(count($errors)>0)
                        <p class="alert alert-danger">Somethings wrong</p>
                @endif
                @if(session('success'))
                    <p class="alert alert-success">QR Code has been rollbacked.</p>
                @endif
                    ...
                    <tbody>
                        @foreach($code_list as $item)
                            ...
                            <tr>
                                ...
                                <td><a href="{{'/rollback/'.$item->id}}">Rollback</a></td>
                            </tr>
                            @endif
                        @endforeach
                    </tbody>
